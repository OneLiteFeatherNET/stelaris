...
@JsonKey(includeToJson: false, includeFromJson: false) NavigationEntry? get unsavedChanges;/// The command palette's entity search: the question, the source's hits
/// and where its answer stands. Transient, like the caches above.
@JsonKey(includeToJson: false, includeFromJson: false) EntitySearchState get entitySearch;@JsonKey(includeToJson: false, includeFromJson: false) AuthState get auth;
...
as NavigationEntry?,entitySearch: null == entitySearch ? _self.entitySearch : entitySearch // ignore: cast_nullable_to_non_nullable
as EntitySearchState,auth: null == auth ? _self.auth : auth // ignore: cast_nullable_to_non_nullable
as AuthState,
  ));
}
/// Create a copy of AppState
...
/// and where its answer stands. Transient, like the caches above.
@override@JsonKey(includeToJson: false, includeFromJson: false) final  EntitySearchState entitySearch;
