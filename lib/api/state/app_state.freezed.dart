...
@JsonKey(includeToJson: false, includeFromJson: false) NavigationEntry? get unsavedChanges;@JsonKey(includeToJson: false, includeFromJson: false) AuthState get auth;/// The command palette's entity search: the question, the source's hits
/// and where its answer stands. Transient, like the caches above.
@JsonKey(includeToJson: false, includeFromJson: false) EntitySearchState get entitySearch;
...
as AuthState,entitySearch: null == entitySearch ? _self.entitySearch : entitySearch // ignore: cast_nullable_to_non_nullable
as EntitySearchState,
  ));
}
/// Create a copy of AppState
/// with the given fields replaced by the non-null parameter values.
