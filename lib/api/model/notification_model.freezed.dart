...
mixin _$NotificationModel {
 ...
 String get uiName; String? get id; String? get variableName; String? get material; FrameType get frameType; String? get title; String? get description;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uiName,id,variableName,material,frameType,title,description);

@override
String toString() {
  return 'NotificationModel(uiName: $uiName, id: $id, variableName: $variableName, material: $material, frameType: $frameType, title: $title, description: $description)';
}
...
@useResult
$Res call({
 String uiName, String? id, String? variableName, String? material, FrameType frameType, String? title, String? description
});
...
/// Create a copy of NotificationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uiName = null,Object? id = freezed,Object? variableName = freezed,Object? material = freezed,Object? frameType = null,Object? title = freezed,Object? description = freezed,}) {
...
class _Notification extends NotificationModel {
  const _Notification({required this.uiName, this.id, this.variableName, this.material, this.frameType = FrameType.task, this.title, this.description}): super._();
...
/// Create a copy of NotificationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uiName = null,Object? id = freezed,Object? variableName = freezed,Object? material = freezed,Object? frameType = null,Object? title = freezed,Object? description = freezed,}) {
